<template>
      ...
      <div class="main-header__layout">
        ...
        <nav class="main-header__nav js-main-header__nav" id="main-header-nav" aria-labelledby="main-header-nav-label" role="navigation">
          ...
          <ul class="main-header__nav-list">
            <li class="main-header__nav-item"><a href="#0" class="main-header__nav-link">About</a></li>
            <li class="main-header__nav-item"><a href="#0" class="main-header__nav-link">Solutions</a></li>
            <li class="main-header__nav-item"><a href="#0" class="main-header__nav-link" aria-current="page">Resources</a></li>
            <li class="main-header__nav-item"><a href="#0" class="main-header__nav-link">Pricing</a></li>
            <li class="main-header__nav-item"><a href="#0" class="main-header__nav-link">Contact</a></li>
    ...
    <section class="feature feature--invert margin-bottom--xxl">
    <div class="feature__inner container container--adaptive">
      <div class="feature__text">
        <div class="feature__text-inner">
          <div class="text-component">
            <small class="feature__label margin-bottom--xs">This is a Label</small>
            <h1>Lorem ipsum dolor sit.</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, rem neque doloribus impedit explicabo minus laborum cupiditate atque esse consectetur.</p>
          </div>
  
          <div class="margin-top--sm">
            <div class="feature__cta flex flex--wrap flex--gap-sm flex--center-y">
              <a href="#0" class="btn btn--primary">Download</a>
              <a href="#0" class="text--inherit">Learn more</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="feature__media">
        <figure>
          <svg width="620" height="420" viewBox="0 0 620 420" preserveAspectRatio="xMinYMin slice">
            <rect width="620" height="420" fill="var(--color-contrast-lower)"/>
            <path d="M216 272L333 155L403.2 272H216Z" fill="var(--color-contrast-low)"/>
            <path d="M239.8 178.8C252.723 178.8 263.2 168.323 263.2 155.4C263.2 142.477 252.723 132 239.8 132C226.877 132 216.4 142.477 216.4 155.4C216.4 168.323 226.877 178.8 239.8 178.8Z" fill="var(--color-contrast-low)"/>
          </svg>
        </figure>
      </div>
    </div>
      ...
      <div class="p-table__content">
        <div class="p-table__grid">
          <div class="p-table__item">
            ...
            <div class="p-table__cta"><a href="#0" class="btn btn--primary btn--md btn--full-width">Sign up</a></div>
          </div> <!-- p-table__item -->
  
          <div class="p-table__item p-table__item--popular">
            <div class="flex flex--space-between flex--center-y margin-bottom--xxs">
